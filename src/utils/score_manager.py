...
class GameScore:
    ...
    def deduct_hint_points(self):
        ...
        hint_penalty = 10  # You can adjust this value as needed
        self.score -= hint_penalty
        self.score = max(self.score, 0)  # Ensure the score doesn't go below zero
        print(f"Hint used! {hint_penalty} points deducted. Current score: {self.score}")
...
def load_scores():
    ...
    if os.path.exists(SCORES_FILE):
        ...
        scores = {str(i): [] for i in range(len(levels))}  # init with empty lists
